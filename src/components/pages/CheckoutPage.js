        ...
        <div className=" bg-gradient-to-br from-purple-400 to-purple 200 w-full h-screen">
            {
                    ...
                    <div className="w-3/6 md:w-1/2 mx-auto bg-white-600 rounded-md my-20 p-8">
                        <form className="flex flex-col space-y-5" onSubmit={handleSubmit}>
                            ...
                            <button className="bg-purple-400 p-3 rounded-lg transform transition hover:bg-purple-500 hover:scale-105 font-semibold text-lg" type="submit" >Checkout</button>
