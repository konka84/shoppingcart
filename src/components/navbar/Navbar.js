...
export default function Navbar() {
    ...
    return (
        <div className={`fixed top-0 px-6 sm:px-12 lg:px-14 xl:px-20 py-5 overflow-y-hidden flex items-start
         md:items-center bg-purple-600 w-full z-10 md:h-24  transform ease-linear duration-300 transition-all max-h-14`}>
            <div className="flex flex-wrap items-center flex-grow">
                <img onClick={() => history.push('/')} className="cursor-pointer transition transform 
                hover:scale-105 hover:bg-opacity-80 border-2 border-night-light-400 mr-2  sm:inline-block
                 w-7 h-7 rounded "
